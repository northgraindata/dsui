...
export default defineConfig({
  ...
  output: "static",
  markdown: {
    processor: unified({ syntaxHighlight: false, remarkPlugins: [remarkHeading, remarkCodeTab, remarkNpm, [remarkStructure, { exportAs: "structuredData" }]], rehypePlugins: [rehypeCode] }),
  },
