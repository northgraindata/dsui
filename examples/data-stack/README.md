...
Open <http://localhost:4192>. Trino, Kafka, and MinIO are already configured. The `events` Kafka topic and `warehouse/readme.txt` MinIO object are created during startup.
